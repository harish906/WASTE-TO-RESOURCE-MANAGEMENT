...
<a href="login1.php"><font color="yellow" size="4"><b>Log In Office</b></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;
...
<a href="contact.php"><font color="yellow" size="4"><b>Contact Us</b></font></a>
  ...
  <div class="simple_form">
    ...
    <form id="registration" method="post" action="signup1.php">
         <img src="img/avatar.png" class="avatar">
         <h1>Sign up Office</h1>
         ...
         <input type="text" name="EmployeeID" id="button" placeholder="Enter your Employee ID " value="<?php echo $EmployeeID; ?>"><br><br>  
